            ...
            <form class="row rounded-2 py-2 justify-content-center mx-5 was-validated" novalidate  id="form">
                ...
                <div class="col-12 col-lg-7">
                    <div class="input-group mb-3">
                        ...
                        <input name="nombre" type="text" class="form-control rounded rounded-start-5" placeholder="NOMBRE(S)" pattern="[a-z A-Z ñ Ñ  ]+" minlength="3" maxlength="42" required>
                        ...
                        <input name="materno" type="text" class="form-control rounded rounded-end-5" placeholder="AP. MATERNO" pattern="[a-z A-Z ñ Ñ  ]+" minlength="3" maxlength="42" required>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-7">
                    <div class="input-group mb-3">
                        <span class="input-group-text fw-bold border border-0 bg-transparent" id="password">PASSWORD: </span>
                        <input class="form-control rounded rounded-pill" type="password" name="password" pattern="(?=^.{8,20}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" minlength="8" maxlength="20" required>
                        <div class="invalid-feedback">
                            Esta debe de al menos contener un número, una minúscula, una mayúscula, estos caracteres especial: - _ / * # etc. y  debe de tener una longuitud de entre 8 a 20 caracteres.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 text-center">
                    <button class="btn btn-outline-success py-0 rounded-pill mx-1" id="go_back" type="button">
                        <i class="fa-solid fa-circle-left"></i> Atrás
                    </button>
