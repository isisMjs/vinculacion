...
if ((isset($_SESSION['tipo']))) ($_SESSION['tipo'] == "USER") ? $clase = "disabled" : $clase = "";
...
<div class="container p-3">
    <div class="row justify-content-center shadow-lg rounded-pill p-1" id="buttons_var">
        ...
        <div class="col-12 col-md-2 my-auto text-center text-md-end">
            <button class="rounded-3 btn btn-outline-light py-0 px-1 d ms-5 <?php echo $display_3 ?> " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Iniciar sesion como alumno" id="btn-usr">
                <i class="fa-solid fa-user <?php echo $display_3 ?>"></i>
            </button>

            <div class="col-12 col-md-2 my-auto text-center text-md-end d-flex justify-content-end">
                <button class="rounded-3 btn btn-outline-light me-2 py-0 px-1 d <?php echo $display_1; ?>" id="btn-noti">
                    <i class="fa-solid fa-bell <?php echo $display_1; ?> text-light"></i>
                </button>

                <button class="rounded-3 btn btn-outline-danger py-0 px-1 ms-2 <?php echo $display_1; ?>" id="btn-press">
                    <i class="fa-solid fa-arrow-right-from-bracket text-danger <?php echo $display_1; ?>"></i>
                </button>
            </div>
